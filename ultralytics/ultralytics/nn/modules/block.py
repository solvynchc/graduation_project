...
class Proto(nn.Module):
    ...
    def __init__(self, c1: int, c_: int = 256, c2: int = 32, aux_mask: bool = False):
        ...
        Args:
            ...
            aux_mask (bool): Whether to enable an auxiliary binary mask head during training.
        """
        super().__init__()
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        if self.training and self.aux_mask is not None:
            return protos, self.aux_mask(feat)
        return protos
