...
def build_data_yaml(
    ...
    data["raw_mask_suffix"] = "_segmentation.png"
...
def main():
    ...
    parser.add_argument("--name", default=cfg.TRAIN_NAME_RAW_AUX_EDGE_P2)
    ...
    data_yaml = build_data_yaml(
        data_root,
        root / "generated" / "skin_data_raw_aux_edge_p2.yaml",
        raw_mask_dir=raw_mask_dir,
        raw_mask_zip=raw_mask_zip,
        raw_mask_zip_root=args.raw_mask_zip_root,
    )
    model_yaml = root / cfg.MODEL_YAML_RAW_AUX_EDGE_P2
