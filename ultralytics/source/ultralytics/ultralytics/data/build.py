...
from ultralytics.data.dataset import GroundingDataset, RawMaskYOLODataset, YOLODataset, YOLOMultiModalDataset
...
def build_yolo_dataset(
    ...
    if not multi_modal and (data.get("raw_mask_dir", "") or data.get("raw_mask_zip", "")):
        dataset = RawMaskYOLODataset
    return dataset(
        img_path=img_path,
        imgsz=cfg.imgsz,
        batch_size=batch,
